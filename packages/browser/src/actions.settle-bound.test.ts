...
// F1: executeAction must separate dispatch from settle. A settle that never lands a real frame
...
describe('F1: settle is bounded — never hangs on a throttled rAF', () => {
  beforeEach(() => {
    vi.resetModules();
