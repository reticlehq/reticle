...
/**
 * G4 — airtight since-causality (settle). After ACT performs the action, executeAction awaits a
 ...
 */
describe('G4 settle: act then observe exactly what it caused', () => {
  // Test A — an in-place text re-render after a click is captured (the M5.5 dom.text case).
