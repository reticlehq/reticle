...
Pair with [`@syrin/iris-server`](https://www.npmjs.com/package/@syrin/iris-server) (the bridge + MCP
server) and optionally [`@syrin/iris-react`](https://www.npmjs.com/package/@syrin/iris-react) for
