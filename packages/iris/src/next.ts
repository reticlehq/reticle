// '@syrin/iris/next' → the Next.js dev-only source-mapping wrapper.
//
// This is a SELF-CONTAINED ESM implementation (not a re-export of the CJS @syrin/iris-next package),
...
/**
 * Wrap your Next config to stamp `data-iris-source` on JSX in dev (so iris_inspect maps DOM → file:line)
 ...
 */
export function withIris(nextConfig: NextConfigLike = {}): NextConfigLike {
