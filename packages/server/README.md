...
WebSocket endpoint your app's `@syrin/iris-browser` SDK connects to, and exposes MCP tools your
...
`iris_observe`, `iris_wait_for`, `iris_assert`, `iris_network`, `iris_console`,
