 ...
 * `@reticlehq/protocol` so the BROWSER SDK can apply it BEFORE the transport (scoping a huge store
 ...
 */
export { selectPath, capDepth, type PathSelection } from '@reticlehq/protocol';
