 ...
 * compilation is explicitly FUTURE (M8 Stage C) — an NL string never reaches here (AnnotationSchema
...
/**
 * M8 Stage B ANNOTATE — human-readable confirmation text for the recorder strip / tool result,
