...
import { irisDirPaths, isValidFlowName, visualDiffPath, visualPath } from './iris-dir.js';

/**
 * N3 VISUAL: on-disk PNG baselines + diffs under .iris/visual/. Binary sibling of FlowStore — same
