...
/** N2 near-miss: how many present calls/levels a zero-match hint samples before truncating. */
...
/**
 * N2 near-miss for iris_network: when a filter matched zero calls, describe what DID fire so the
...
/**
 * N2 near-miss for iris_console: when a level filter matched zero logs, report what levels ARE
