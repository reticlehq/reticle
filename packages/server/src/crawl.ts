...
import { parseInteractive, asRecord, asNumber, asString } from './tools-helpers.js';
...
/**
 * N4 EXPLORE: the autonomous "smart monkey". Discovers every reachable interactive control once,
