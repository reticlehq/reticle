...
const PINNED_VERSIONS: Record<string, string> = {
  'packages/core/src/flow-types.ts': 'FLOW_FILE_VERSION',
  'packages/core/src/intent.ts': 'INTENT_FILE_VERSION',
  'packages/core/src/project-registry.ts': '1',
  'packages/core/src/types.ts': 'CONTRACT_FILE_VERSION,PROJECT_FILE_VERSION',
  'packages/server/src/capsule/capsule-store.ts': 'CAPSULE_VERSION',
