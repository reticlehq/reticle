...
import type { ElementBox, RealInputProvider, ScreenshotOpts } from './real-input.js';
...
/**
 * N3 VISUAL (M11): the opt-in pixel layer. Both tools require a DRIVEN browser (iris drive /
