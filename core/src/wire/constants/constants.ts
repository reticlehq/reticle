...
// The event vocabulary lives beside this file and is re-exported here, so `EventType` stays one
// import path for every consumer. See event-types.ts for why it moved.
