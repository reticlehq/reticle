...
> Procuring a license: contact **hey@syrin.ai**. Keys are issued offline and signed with Ed25519; the
> activation you run (`iris license`) verifies them locally with no network call.
