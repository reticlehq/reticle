...
| --- | --- |
| `0` | Success |
| `1` | The API call failed, the repository is not attached where attachment is required, or `push` had an artifact refused |
| `2` | Usage error, or not signed in and no `RETICLE_API_KEY` |
