...
import `@syrin/iris-browser`. They depend on a tiny structural interface, `IrisEmitter` (`{ signal, state
...
nothing breaks in production or before connect, and **`@syrin/iris-browser` stays out of the prod bundle.**
