...
Enforced by `server/src/tools/integration-coverage.test.ts`, which fails when a shipped integration has no covering app and spec. It is a red build, not a convention.
