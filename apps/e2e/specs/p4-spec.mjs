import { irisTest, bootSession, runSpecs, createTestContext } from '@iris/test';
...
console.log('\n=== @iris/test running 3 specs headless via iris drive ===');
...
console.log(`\n${summary.ok ? '✅ @iris/test SUITE GREEN' : '❌ FAILED'}  passed=${summary.passed} failed=${summary.failed} skipped=${summary.skipped}`);
await booted.close();
