...
console.log('\n=== @syrin/iris-test running 3 specs headless via iris drive ===');
...
console.log(`\n${summary.ok ? '✅ @syrin/iris-test SUITE GREEN' : '❌ FAILED'}  passed=${summary.passed} failed=${summary.failed} skipped=${summary.skipped}`);
await booted.close();
