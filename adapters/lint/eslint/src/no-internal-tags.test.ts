...
ruleTester.run('no-internal-tags (paths)', noInternalTags, {
  valid: [
    { code: '// ordinary', filename: 'server/src/ring-buffer.ts' },
    ...
    { code: '// ordinary', filename: 'core/src/utf8-decode.ts' },
    { code: '// ordinary', filename: 'server/src/http2-client.ts' },
    { code: '// ordinary', filename: 'core/src/base64.ts' },
    // Established terms keep their exemption in a path, same as in prose.
    { code: '// ordinary', filename: 'server/src/s3-upload.ts' },
