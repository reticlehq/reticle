...
Compares **Playwright MCP**, **Chrome DevTools MCP**, and **Iris** on 10 injected-regression
scenarios. Everything here is measured by the harness; nothing is hand-entered.
