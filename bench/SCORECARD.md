...
| **Hard: state/UI desync** (UI lies about the store — class of 2)      | **2/2 CAUGHT** (count + status, ~47–67 tok)     | 0/2                    | 0/2          | **Iris-only capability** — competitors read the displayed value but have no store truth to contradict it. (`HARD-BENCH.md`) |
