 ...
 */
// This package's source, named rather than counted. It was one level up from here, which was true
// when this file sat directly under `src/`; the directories were then grouped and it began scanning
// one group instead of the package -- so the declared bypasses all looked like they had gone away.
